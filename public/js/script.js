...
function submitLogin() {
    ...
    if (roles === "Select your role" || !username || !password) {
        document.getElementById("warning").textContent = "Please Fill All The Field";
    } else {
...
document.getElementById("username").addEventListener("input", () => {
    const username = document.getElementById('username').value;
    if (!username) {
        document.getElementById("usernameErr").textContent = "require";
    } else {
...
document.getElementById("password").addEventListener("input", () => {
    const password = document.getElementById('password').value;
    if (!password) {
        document.getElementById("passwordErr").textContent = "require";
    } else {
        document.getElementById("passwordErr").textContent = "";
    }
})

document.getElementById("roles").addEventListener("input", () => {
    const roles = document.getElementById('roles').value;
    if (!roles) {
        document.getElementById("selectErr").textContent = "require";
    } else {
